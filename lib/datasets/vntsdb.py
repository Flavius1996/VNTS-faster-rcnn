...
# Written by Ross Girshick - Modified for VNTSDB by Hoang Huu Tin
# --------------------------------------------------------
...
class vntsdb(imdb):
    def __init__(self, image_set, year, devkit_path=None):
        imdb.__init__(self, 'vntsdb' + year + '_' + image_set)
        self._year = year
        ...
        # VNTSDB specific config options
    ...
    def _get_default_path(self):
        ...
        """
        return os.path.join(cfg.DATA_DIR, 'VNTSDB')
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_vntsdb_annotation(index)
    ...
    def _load_vntsdb_annotation(self, index):
        """
...
if __name__ == '__main__':
    from datasets.vntsdb import vntsdb
    d = vntsdb('train', '')
    res = d.roidb
